...
import { setJobId , fetchMyBookingRequest , fetchMyBookingError , fetchMyBookingSuccess } from '../../actions/job'
...
class MyBooking extends Component {
    ...
    _getMyBooking(){
        setTimeout(async ()=>{
            ...
            let response = await fetch(`http://${Config.apiServer[Config.server]}/api/omc/job/getMyBooking/${this.props.jobState.fetchMyQuotes.page}`, options)
